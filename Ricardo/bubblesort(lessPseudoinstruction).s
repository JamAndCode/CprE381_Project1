...
main:
	...
	addi $s0, $s0, 0				# Set counter s0 = 0 for loop 1
	addi $s6, $s6, 10 				# N - 1
	
	addi $s1, $s1, 0 				# Set counter s1 = 0 for loop 2

	addi $t3, $t3, 0				# Set counter s3 = 0 for printing
	addi $t4, $t4, 11				# Number of inputs -1
